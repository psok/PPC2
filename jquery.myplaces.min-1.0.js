...
n();
g(q)
}function n(){var q={zoom:11,center:new google.maps.LatLng(41.8569, -87.6847),mapTypeId:google.maps.MapTypeId.ROADMAP};
...
var b={places:[],country:"USA",placeListTemplate:"<li>Enter a template for the list of places</li>",placeInfoTemplate:"<div>Enter a template for the information of the place</div>",popUpMapTemplate:"<div>Enter a template for the pop-up of the place</div>",onLoad:function(){},onPlacesChange:function(){},onClickPlace:function(){}};
a.extend(b,c);
